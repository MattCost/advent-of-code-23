...
//     Sums.Values.ToList().ForEach(Console.WriteLine);

//     var length2 = CalculateTrenchLength(startingNode);
...
//     Console.WriteLine($"StartingKey {startingKey}");
